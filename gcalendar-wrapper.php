 ...
 */
$calColorBgDark      = '#90c275';	// dark background color
$calColorTextOnDark  = '#FFF';	// text appearing on top of dark bg color
$calColorBgLight     = '#c7e0b9';	// light background color
$calColorTextOnLight = '#666';	// text appearing on top of light bg color
$calColorBgToday     = '#9F3';	// background color for "today" box
